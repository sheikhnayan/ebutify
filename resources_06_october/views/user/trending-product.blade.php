            ...
            <a type="button" class="btn btn-facebook-ads" target="_blank" href="{{url('tutorial')}}"><i class="fas fa-video"></i> Tutorials</a>
               ...
               <form id="filterForm" method="get" action="{{ route('trending-products') }}">
                  <div class="row mx-2">
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-3 my-1">
                        <form class="form-control select2 filter-item" method="get" action="{{ route('trending-products') }}">
...
<?php $product_id = $trendingProduct->id ?>
                <div class="row mx-4 px-2 mb-2 justify-content-center rounded icon-btn">
                  <a target="_blank" href="{{route('product-details',[$product_id])}}" type="button" class="btn fb-ads-card-btn">View Product Details</a>
                </div>
              </div>
</div>
@endforeach
