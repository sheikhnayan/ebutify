                ...
                <div class="row eb-b-service-card row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm">
                            <a href="/blog/{{str_replace(' ', '-', $item->heading)}}"><img src="{{ asset('storage/'.$item->image) }}" class="card-img-top" alt="..."></a>
                            <div class="card-body">
                                <a href="/blog/{{str_replace(' ', '-', $item->heading)}}"><h3 class="card-title">{{ $item->heading }}</h3></a>
