...
<!--                 <form class="row mb-3 mt-1">
                ...
                <form class="col-12" method="get" action="{{ route('super/amazon-products') }}">
                  <div class="col-12">
            ...
            <table class="bg-white table table-hover table-bordered table-responsive">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="{{ route ('super/amazon-edit-products', ['id' => $productDetail->id]) }}" class="btn btn-primary">Edit</a>
                  </td>
                  <td>
