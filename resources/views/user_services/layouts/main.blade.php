    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/dashboard" class="@if(Route::currentRouteName() == 'freelancer-dashboard') nav-link active  @endif nav-link">
          ...
          <li class="nav-item">
            <a href="/ebutify-services" class="@if(Route::currentRouteName() == 'ebutify-services') nav-link active  @endif nav-link">
          ...
          <li class="@if(Route::currentRouteName() == 'all-projects') menu-open @endif nav-item">
            <a href="#" class="@if(Route::currentRouteName() == 'all-projects') nav-link active  @endif nav-link">
            ...
            <ul class="nav nav-treeview pl-4 ml-2">
              <li class="nav-item">
                <a href="/all-projects" class="@if(Route::currentRouteName() == 'all-projects') nav-link active  @endif nav-link">
                  <p>All Projects</p>
                </a>
              </li>
            </ul>
