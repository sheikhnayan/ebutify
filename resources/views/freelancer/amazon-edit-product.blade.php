                    ...
                    <div class="col-12">
                      <div class="row pt-3 pl-3">
                        <div class="col-lg-12 amazon-form-content pl-2 pr-3 pb-4">
                          ...
                          @endif
                          <form class="pr-2" action="{{ route('amazon-product-update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="pname" class="form-control" id="inputProduct" value="{{$productDetails->product_name}}">
                            </div>
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="form-row">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="amz_link" class="form-control" id="inputAmazonLink" value="{{$productLinks->amazon}}">
                                  </div>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-row">
                                  <div class="form-group col-md-5">
                                    ...
                                    <input type="text" name="img_link" class="form-control" id="inputImageLink" value="{{$productImages->image_link_1}}">
                                  </div>
