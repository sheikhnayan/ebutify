        ...
        <div class="row">
            <div class="col-md-12">
                <form class="row mb-3 mt-1">
                    ...
                    <div class="col-12 col-sm-auto pl-sm-0">
                        <a href="/super/tutorials/create" class="btn my-2 my-sm-0 btn-primary">Add New Tutorial</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="bg-white table table-hover table-bordered table-responsive">
              ...
              <tbody id="myTable">
                ...
                <tr>
                  ...
                  <td>
                    <a href="/super/tutorials/edit/{{ $item->id }}" class="btn btn-primary">Edit</a>
                    <a href="/super/tutorials/delete/{{ $item->id }}" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
