        ...
        <ul class="nav navbar-nav">
          ...
          <li class="menu-item-has-children dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <ul class="sub-menu children dropdown-menu">
                ...
                <li><i class="fa fa-id-card-o"></i><a href="{{route('trending-products')}}">Trending Products</a></li>
          ...
          <li class="menu-item-has-children dropdown">
            ...
            <ul class="sub-menu children dropdown-menu">
              ...
              <li><i class="menu-icon fa fa-th"></i><a href="../pages/succes.html">Success Academy</a></li>
          ...
          <li><a href="pages/tutorial.html"><i class="menu-icon fa fa-video-camera"></i>Tutorials</a></li>
          <li><a href="pages/faq.html"><i class="menu-icon fa fa-question"></i>FAQ</a></li>
          <li><a href="pages/contact.html"><i class="menu-icon fa fa-phone"></i>Contact us</a></li>
        </ul>
      </div>
      <!-- /.navbar-collapse -->
    </nav>
    ...
    <header id="header" class="header">
      <div class="top-left">
        <div class="navbar-header">
          ...
          <a class="navbar-brand hidden" href="index.html">eButify</a>
