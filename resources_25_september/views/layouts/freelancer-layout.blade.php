...
<head>
  ...
  @if(Route::currentRouteName() == 'freelancer-dashboard')
  <title>eButify | Freelancer Dashboard</title>
  @elseif(Route::currentRouteName() == 'product-research')
      ...
      <li class="nav-item dropdown">
        <a class="" data-toggle="dropdown" href="#">
          <div class="user-panel d-flex mr-3">
            <div class="image">
              <img src="{{asset('storage/'.Auth::user()->profile_photo_path) ?? 'assets/img/avatar5.png'}}" class="img-circle " alt="{{Auth::user()->name}}">
            </div>
          </div>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
