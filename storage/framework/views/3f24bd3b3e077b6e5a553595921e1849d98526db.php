      ...
      <div class="content-wrapper">
         ...
         <section class="content">
            <div class="container-fluid">
               ...
               <form class="col-12" method="get" action="<?php echo e(route('untapped-product')); ?>">
                  <div class="col-12">
               ...
               <!-- /.row -->
               <form id="filterForm" method="get" action="<?php echo e(route('untapped-product')); ?>">
                  <div class="row mx-2">
...
<div class="col-md-4 mt-4">
                     <div class="card shadow" style="min-width: 280px;">
                        <div class="row px-2" data-toggle="modal" data-target="#modal_demo<?php echo e($j); ?>">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <div class="modal fade" id="modal_demo<?php echo e($j); ?>" tabindex="-1" role="dialog" aria-labelledby="modal_demo<?php echo e($j); ?>" aria-hidden="true">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layoutsUser.user4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/user/practice-untapped-product.blade.php ENDPATH**/ ?>