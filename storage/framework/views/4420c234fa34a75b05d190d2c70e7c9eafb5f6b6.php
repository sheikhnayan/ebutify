...
<head>
  ...
  <?php if(Route::currentRouteName() == 'amazon-products' || Route::currentRouteName() == 'add-new-amz'): ?>
  <title>eButify | Amazon Product List</title>
  <?php elseif(Route::currentRouteName() == 'ali-express-products' || Route::currentRouteName() == 'add-new-ali'): ?>
  <title>eButify | Ali Express Product List</title>
  <?php elseif(Route::currentRouteName() == 'shopify-products' || Route::currentRouteName() == 'add-new-shopify'): ?>
...
<?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/layouts/freelancer-amazon-layout.blade.php ENDPATH**/ ?>