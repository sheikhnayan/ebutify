               ...
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item menu-open">
                     ...
                     <ul class="nav nav-treeview pl-4 ml-2">
                        <li class="nav-item">
                           <a href="<?php echo e(url('fb-ad-products')); ?>" class="<?php if(Route::currentRouteName() == 'fb-ad-products'): ?> nav-link active <?php endif; ?> nav-link">
                              <i class="nav-icon fab fa-facebook-square"></i>
                              <p>Facebook Ads</p>
                           </a>
                        </li>
                        <li class="nav-item">
                           <a href="<?php echo e(route('untapped-product')); ?>" class="<?php if(Route::currentRouteName() == 'untapped-product'): ?> nav-link active <?php endif; ?> nav-link">
                              <i class="nav-icon fas fa-upload"></i>
                              <p>Untapped Products</p>
                           </a>
                        </li>
                        <li class="nav-item">
                           <a href="<?php echo e(url('trending-products')); ?>" class="nav-link">
                              <i class="nav-icon fas fa-vector-square"></i>
                              <p>Trending Products</p>
                           </a>
                        </li>
                        <li class="nav-item">
                           <a href="<?php echo e(url('all-product')); ?>" class="nav-link">
...
</html><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/layoutsUser/user4.blade.php ENDPATH**/ ?>