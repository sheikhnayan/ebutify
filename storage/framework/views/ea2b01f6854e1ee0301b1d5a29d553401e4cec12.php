                    ...
                    <div class="col-12">
                      <div class="row pt-3 pl-3">
                        <div class="col-lg-12 amazon-form-content pl-2 pr-3 pb-4">
                          ...
                          <?php endif; ?>
                          <form action="/super/privacy-policy/update" method="post" enctype='multipart/form-data'> 
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ebutify\ebutify_freelancer\resources\views/admin/privacy-policy-index.blade.php ENDPATH**/ ?>