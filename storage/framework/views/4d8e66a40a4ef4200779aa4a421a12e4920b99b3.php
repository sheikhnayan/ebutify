    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row mx-2 my-3">
          ...
          <form class="col-12" method="get" action="<?php echo e(route('ali-product')); ?>">
            <div class="col-12">
        ...
        <form id="filterForm" method="get" action="<?php echo e(route('ali-product')); ?>">
        <div class="row mx-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layoutsUser.user3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/user/explore-ali.blade.php ENDPATH**/ ?>