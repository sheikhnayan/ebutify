                    ...
                    <div class="col-12">
                      <div class="row pt-3 pl-3">
                        <div class="col-lg-12 amazon-form-content pl-2 pr-3 pb-4">
                          ...
                          <?php endif; ?>
                          <form class="pr-2" action="<?php echo e(route('upload-amazon')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.freelancer-amazon-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/freelancer/add-new-amz.blade.php ENDPATH**/ ?>