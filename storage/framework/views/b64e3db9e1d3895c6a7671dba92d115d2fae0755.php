                    ...
                    <div class="row eb-front-page-head">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="eb-font-page-image">
                                <img src="<?php echo e(asset('front/images/hero-image.png')); ?>" width="100%" height="100%">
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="row trusted-add shadow">
                                <div class="col-2 trusted-add-image">
                                    <img src="<?php echo e(asset('front/images/Asset-5-1.svg')); ?>" style="max-width: 50%;">
                                </div>
                ...
                <div class="row eb-service-card row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card">
                            <div class="elementor-ebutyfy-center px-5">
                                <img width="170" height="170" src="<?php echo e(asset('front/images/card-1.png')); ?>" class="card-img-top" alt="..." max-width="170" max-height="170">
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card eb-service-m-card h-100">
                            <div class="elementor-ebutyfy-center px-5">
                                <img width="200" height="150" src="<?php echo e(asset('front/images/grow.png')); ?>" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="elementor-ebutyfy-center px-5">
                                <img width="173" height="173" src="<?php echo e(asset('front/images/support.png')); ?>" class="card-img-top" alt="..." max-width="170" max-height="170">
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('front.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/front/index.blade.php ENDPATH**/ ?>