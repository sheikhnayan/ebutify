        ...
        <div class="row">
            <div class="col-md-12">
                <form class="row mb-3 mt-1">
                    ...
                    <div class="col-12 col-sm-auto pl-sm-0">
                        <a href="<?php echo e(route('add-new-ali')); ?>"  class="btn my-2 my-sm-0 btn-primary">Add New Product</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="bg-white table table-hover table-bordered table-responsive">
              ...
              <tbody id="myTable">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo e(route ('ali-product-edit', ['id' => $productDetail->id])); ?>" class="btn btn-primary">Edit</a>
                  </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer-amazon-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/freelancer/explorer-ali-express.blade.php ENDPATH**/ ?>