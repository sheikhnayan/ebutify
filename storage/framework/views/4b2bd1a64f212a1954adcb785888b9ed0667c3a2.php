            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h3>Category: <?php echo e($cat->category_name); ?></h3>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('front.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ebutify\ebutify_freelancer\resources\views/front/category.blade.php ENDPATH**/ ?>