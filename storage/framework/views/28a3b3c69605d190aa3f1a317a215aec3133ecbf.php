    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row mx-2 my-3">
          ...
          <form class="col-12" method="get" action="<?php echo e(route('all-product')); ?>">
            <div class="col-12">
        ...
        <form id="filterForm" method="get" action="<?php echo e(route('all-product')); ?>">
          <div class="row mx-2">
...
<div class="col-md-4 mt-4">
              <div class="card shadow" style="min-width: 280px;">
                ...
                <div class="row px-2 video-icon">
                  <img src="<?php echo e($trendingProduct->productImage[0]->image_link_1); ?>" class="card-img-top img-fluid" alt="...">
...
<?php $product_id = $trendingProduct->id ?>
                <div class="row mx-4 px-2 mb-2 justify-content-center rounded icon-btn">
                  <a href="<?php echo e(route('all-product-details',[$product_id])); ?>" type="button" class="btn fb-ads-card-btn">View Product Details</a>
                </div>
              </div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layoutsUser.user3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\ebutify_freelancer\resources\views/user/all-product.blade.php ENDPATH**/ ?>