                                    ...
                                    <div class="modal-body untapped-p-modal pt-1">
                                                                  ...
                                                                  <div class="col-12">
                                                                      <?php if (!empty($links)) {
                                                                        foreach ($links as $link) {
                                                                          ...
                                                                          ?><p><img src="{{asset('assets/img/web-icon.png')}}" style="width: 20px; margin-top: -6px;" alt="">  {{$split1[0]}}com...<a href="{{$link}}"></a></p><?php
                                                                        }
                                                                      } ?>
                                                                  </div>
                                                               </div>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-12 modal-footer px-0 mt-2">
                                             ...
                                             <a href="{{route('product-details',[$product_id])}}" type="button" class="btn btn-modal-product">View Product</a>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
