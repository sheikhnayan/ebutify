                      ...
                      <div class="card-deck">
                        ...
                        <div class="col-md-4 mt-4">
                          ...
                          <div class="row px-2 mb-2 rounded justify-content-center">
                            <a href="" class="cae-view"><img src="{{$trendingProduct->productLink[0]->aliexpress}}" class="img-fluid" style="width: 16px; margin: 5px;" alt="" target="_blank"> View on a Demo</a>
                          </div>
                          <div class="col-6 text-center p-0">
                            <a href="{{$trendingProduct->productLink[0]->amazon}}" class="cae-view rounded px-2 py-1" style="color: #918C9B;"><i class="fab fa-amazon" style="background: #191919; color: #fff; font-size: 12px; padding: 2px; line-height: 13px;"></i> View On Amazon</a>
                          </div>
                        </div>
                        </div>
                        @endforeach
